...
"""
    ...
    def run_full_suite(self, monitoring_duration_minutes: int = 45) -> List[Dict[str, Any]]:
        ...
        test_cases = [
            {
                'test_id': 'EX-01',
                'description': 'DNS Exfiltration - 900 domains, moderate rate',
                'domain': TEST_DOMAIN,
                'data_size_kb': 10,
            ...
            {
                'test_id': 'EX-02',
                'description': 'DNS Exfiltration - 1000 domains, moderate rate',
                'domain': TEST_DOMAIN,
                'data_size_kb': 15,
                'queries_per_second': 10
            },
            {
                'test_id': 'EX-03',
                'description': 'DNS Exfiltration - 1200 domains, high rate',
                'domain': TEST_DOMAIN,
                'data_size_kb': 20,
            ...
            {
                'test_id': 'EX-04',
                'description': 'DNS Exfiltration - 1500 domains, slow rate ',
                'domain': TEST_DOMAIN,
                'data_size_kb': 25,
            ...
            {
                'test_id': 'EX-05',
                'description': 'DNS Exfiltration - 2000 domains, high volume test',
                'domain': TEST_DOMAIN,
                'data_size_kb': 30,
                'queries_per_second': 10
            }
...
def main():
    ...
    EC2_INSTANCE_ID = "i-02e572dc2e7d1e61d"
